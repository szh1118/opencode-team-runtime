---
description: A-zone implementation worker for narrow coding tasks. Use for boilerplate, small edits, tests, and repetitive code. Must record evidence and cannot self-approve.
mode: subagent
temperature: 0.2
permission:
  read: allow
